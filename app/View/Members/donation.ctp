...
<section class="login-outer">
  ...
  <form action="https://www.paypal.com/cgi-bin/webscr" id="donation" name="donation" method="post" class="form-center" >
            <div class="fullWidth">
            <label>First Name<em class="em_color">*</em> :</label>
		<input id="first_name" class="titleInput" type="text" placeholder="First Name" name="first_name">
            </div>
             <div class="fullWidth">
              <label>Last Name<em class="em_color">*</em> :</label>
	<input id="last_name" class="titleInput" type="text" placeholder="Last Name" name="last_name">
            </div>
              <div class="fullWidth">
              <label>E-mail<em class="em_color">*</em> :</label>
		<input id="email" class="titleInput" type="text" placeholder="Email" name="email"> 
            </div>
<!--hidden field start -->
<input type="hidden" name="business" value="kcblynkd@gmail.com">
...
<input type="hidden" name="cancel_return" value="<?php  echo $base_url; ?>?status=ERROR">
<input type="hidden" name="return" value="<?php  echo $base_url; ?>?status=SUCCESS">
...
<div class="fullWidth">
              ...
              <div class="fullWidth">
              <label>Donation Amount<em class="em_color">*</em> :</label>
