        ...
        <div class="bc">
            ...
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li><a href="<?php echo $this->Html->url(array('controller'=>'activities','action'=>'admin_index')); ?>">Activity Management</a></li>
                 <li class="current"><a href="javascript:void:(0)">Edit Activity</a></li>
		</ul>
...
?>
    <div class="wrapper">
        ...
        <div class="whead"><h6>Edit user</h6></div>
		

        <div id="dyn" class="hiddenpars">
             <?php echo $this->Form->create('Activity',array('action'=>'admin_edit','id'=>'validate','type'=>'file','onsubmit'=>'return loaderChecking();')); ?>
                <div class="formRow">
                ...
                <div class="formRow">
                    ...
                    <div class="grid9">
                    <?php echo $this->Form->input('video', array('label'=>"",'type'=>'file'));?>
                   </div>
                </div>      
                <div class="formRow">
                    <div class="grid3"><label>You Tube Link:</label></div>
                    <div class="grid9">
                    <?php echo $this->Form->input('you_tube_link', array('label'=>"",'type'=>'url'));?>
                    </div>
                </div>
                <div class="formRow">
