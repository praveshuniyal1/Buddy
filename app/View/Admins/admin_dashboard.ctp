...
<div id="content">
    ...
    <div class="wrapper">
     <?php $x=$this->Session->flash(); ?>
		...
		<div class="span3">
		<a href="<?php echo $this->Html->url(array('controller'=>'Members','action'=>'admin_index')); ?>" class="info-tiles tiles-inverse has-footer">
		...
		<div class="span3">
		<a href="<?php echo $this->Html->url(array('controller'=>'Locations','action'=>'admin_index')); ?>" class="info-tiles tiles-blue has-footer">
			    <div class="tiles-heading">
