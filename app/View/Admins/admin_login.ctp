...
<div class="loginWrapper">
	...
	<!-- Current user form -->
   <?php echo $this->Form->create('Admin',array('method'=>'post','id'=>'validate')); ?>
     <div class="loginPic" >
        ...
        <div class="logControl">        
			<?php echo $this->Form->submit('Login',array('name'=>'submit','value'=>'Login','class'=>'buttonM bBlue')); ?>
        <div>
            <a href="<?php echo $this->Html->url(array('controller'=>'users','action'=>'admin_forget')); ?>" class="forget-password" style="text-decoration: none;" >Forgot Password </a></div>
        </div>       
    </form>   
</div>
<script type="text/javascript">
